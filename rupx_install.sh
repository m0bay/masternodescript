...
COIN_DAEMON='rupayad'
COIN_CLI='rupaya-cli'
COIN_TGZ='https://s3-us-west-2.amazonaws.com/rupx/28.1/linux-x64.tar.gz'
...
addnode=52.40.179.237
whitelist=52.40.179.237
addnode=52.24.15.150
whitelist=52.24.15.150
addnode=13.232.34.36
addnode=18.237.101.25
addnode=34.217.103.56
addnode=52.24.15.150
addnode=18.237.73.253
listen=1
server=1
daemon=1
port=$COIN_PORT
